...
Característica: Afegir un descompte manual
  ...
  Escenari: Afegir un descompte manual (percentatge)
    ...
    Quan Aplico un descompte manual que anomeno "opt-25%" al producte 1 de la línia de venda amb valor 25%
  ...
  Escenari: Descomptem una línia que no existeix
    ...
    Quan Aplico un descompte manual que anomeno "foo-99%" al producte 3 de la línia de venda amb valor 99%

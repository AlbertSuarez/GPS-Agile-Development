...
Característica: Obtenir el canvi d'una venta
  ...
  Rerefons:
    Donat un producte amb nom "Optimus Prime", preu 23.00€, iva 21% i codi de barres 1234567
  ...
  Escenari: Cobrar una venta en metàlic
    ...
    Quan indico que el client ha entregat 30.00€ per a pagar en metàlic
    Aleshores el tpv m'indica que el canvi a retornar és de 7.00€

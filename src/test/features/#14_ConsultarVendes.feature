...
Característica: Consultar vendes
  ...
  Escenari: llista totes les vendes
    ...
    Aleshores la venda 1 conté el producte amb nom "Optimus Prime" venut el dia "12/02/2013" a les 11 hores 20 minuts i 30 segons amb import total €23€
  ...
  Escenari: llistar vendes d'un dia determinat
    ...
    I la venda 1 conté el producte amb nom "Optimus Prime" venut el dia "12/02/2013" a les 11 hores 20 minuts i 30 segons amb import total €23€
  ...
  Escenari: llistar vendes d'un periode
    ...
    I la venda 1 conté el producte amb nom "Optimus Prime" venut el dia "12/02/2013" a les 11 hores 20 minuts i 30 segons amb import total €23€
    I la venda 2 conté el producte amb nom "Playmobil" venut el dia "13/02/2013" a les 11 hores 20 minuts i 30 segons amb import total €23€
  ...
  Escenari: llistar vendes amb més d'una linia de venda
    ...
    Quan vull llistar les vendes del dia "12/02/2013"
    Aleshores obtinc 1 venda
    I la venda 1 esta feta el dia "12/02/2013" a les 11 hores 20 minuts i 30 segons amb import total €46€
